    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            DisplayMsg::KeypairNotFound(keypair_name) =>
                write!(f, "Error: Keypair name {keypair_name} provided does not exist. Please generate a keypair by `./pchain_client keys create --keypair-name <NAME>`"),
            ...
            `./pchain_client keys add --private-key <PRIVATE_KEY> --public-key <PUBLIC_KEY> --keypair-name <NAME>` to re-import your keys"),
